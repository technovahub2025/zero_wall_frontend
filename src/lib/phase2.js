...
export function normalizeTask(record = {}) {
  ...
  return {
    ...
    timerPausedAt: record.timerPausedAt || null,
    timerExpiresAt: record.timerExpiresAt || null,
    timerStatus: record.timerStatus || 'not_started',
    timerBudgetSeconds: Number(record.timerBudgetSeconds || 0),
    timerRemainingSeconds: Number(record.timerRemainingSeconds || 0),
